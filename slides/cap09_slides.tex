...
\begin{frame}{Exemplo preenchido e a versão MetPy}
  \begin{columns}
    ...
    \column{0.33\textwidth}
    \begin{center}\includegraphics[width=\linewidth]{notebook_modelo_estacao.png}\\[-2pt]
...
\begin{frame}{Da nuvem de números ao campo}
  \begin{columns}
    ...
    \column{0.35\textwidth}
    \figlivroref{Fig.~9.20}{\ldots e a análise pronta}{Environment Canada}
  \end{columns}
\end{frame}
...
\begin{frame}{Regras de ouro da análise}
  \begin{columns}
    ...
    \begin{center}\includegraphics[width=\linewidth]{notebook_analise_objetiva.png}\\[-2pt]
