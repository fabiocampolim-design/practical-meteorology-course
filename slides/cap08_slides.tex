...
\begin{frame}{De que altura vem o sinal?}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.56\textwidth}
    \begin{center}\includegraphics[width=\linewidth]{notebook_funcoes_peso.png}\\[-2pt]
...
\begin{frame}{Os canais reais de um sondador}
  \begin{columns}
    ...
    \end{itemize}
    \column{0.6\textwidth}
    \figlivroslide{fig_08_11c.jpg}{0.56\textheight}{Fig.~8.11 --- funções
      peso dos canais do sondador GOES}
  \end{columns}
\end{frame}
...
\begin{frame}{As mesmas nuvens em dois canais}
  \begin{columns}
    ...
    \figlivroslide{fig_08_16a.jpg}{0.46\textheight}{Fig.~8.16 --- canal
      visível}
    \column{0.35\textwidth}
    \figlivroslide{fig_08_16d.jpg}{0.46\textheight}{Fig.~8.16 --- canal
      infravermelho}
  \end{columns}
\end{frame}
