...
## What the suite guards (`tests/test_course.py`, 26 checks)
...
and write their logs; `audita.py` lists a missing guide or a chapter file without a number instead of raising
